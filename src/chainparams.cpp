...
{
    const char* pszTimestamp = "Have You BONKed Today?";
    const CScript genesisOutputScript = CScript() << ParseHex("04a98f1bc72b65f50c2f1f1c92b7a4e841ff467f0f3d4a4f11a1bbd64c57f63b42b6f1b48c9f42c6e713f1d5737e739b7e0a8a6f8db3e841c19a6a1189b0c7d92b") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1736363636, 2000493699, 0x1e0ffff0, 1, 500000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xec452290ea2f37f451a82e30c13018b2c486cd33f156425918c162efcf9eecdf"));
        assert(genesis.hashMerkleRoot == uint256S("0x09de773d2c353ce9d07fa07147737decfac429a4b58e9a3a61ef7d611e11160b"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("3.136.34.227", "3.136.34.227", true));
        vSeeds.push_back(CDNSSeedData("3.146.108.5", "3.146.108.5", true));
        vSeeds.push_back(CDNSSeedData("3.146.90.153", "3.146.90.153", true));
        vSeeds.push_back(CDNSSeedData("18.224.250.194", "18.224.250.194", true));
        
        //vSeeds.push_back(CDNSSeedData("bonkcointools.com", "dnsseed.bonkcointools.com"));
        //vSeeds.push_back(CDNSSeedData("bonkcoinpool.org", "dnsseed.bonkcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xec452290ea2f37f451a82e30c13018b2c486cd33f156425918c162efcf9eecdf"))
        ...
        chainTxData = ChainTxData{
            ...
            1736363636, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 0.25 * 24 * 60 * 60; // 3.5 days
        consensus.nPowTargetSpacing = 1 * 60;
        ...
        genesis = CreateGenesisBlock(1736363636, 925907, 0x1e0ffff0, 1, 500000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe32f647f5da20749c328bea2cf40d1a0fec5c7ad6b86aff6b886b7f15f85ff1d"));
        assert(genesis.hashMerkleRoot == uint256S("0x09de773d2c353ce9d07fa07147737decfac429a4b58e9a3a61ef7d611e11160b"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("bonkcointools.com", "testnet-seed.bonkcointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bonkcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xe32f647f5da20749c328bea2cf40d1a0fec5c7ad6b86aff6b886b7f15f85ff1d")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1736363636, 0, 0x207fffff, 1, 500000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc4dc1c87265c6de52ba99efe3d02259c3c2bf9bf451830441bb754345b42a6e0"));
        assert(genesis.hashMerkleRoot == uint256S("0x09de773d2c353ce9d07fa07147737decfac429a4b58e9a3a61ef7d611e11160b"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xc4dc1c87265c6de52ba99efe3d02259c3c2bf9bf451830441bb754345b42a6e0"))
        };
