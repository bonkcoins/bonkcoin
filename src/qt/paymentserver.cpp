...
const char* BIP71_MIMETYPE_PAYMENT = "application/bonkcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bonkcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bonkcoin-paymentrequest";
